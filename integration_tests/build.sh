...
docker run -v $PWD:$PWD --rm -i ligolang/ligo:0.24.0 compile contract $PWD/contracts/main/yToken.ligo  > integration_tests/compiled/yToken.tz

docker run -v $PWD:$PWD --rm -i ligolang/ligo:0.24.0 compile contract $PWD/contracts/main/priceFeed.ligo  > integration_tests/compiled/priceFeed.tz
